...
using BikeSeviceInventoryManagement.Pages;
...
namespace BikeSeviceInventoryManagement.Data
{
    public static class InventoryService
    {
        ...
        public static List<InventoryItems> WithdrawItem(Guid userId,Guid id, string itemName, int quantity)
        {
            ...
            if (currentTime.Hour >= 7 && currentTime.Hour < 16 && currentTime.DayOfWeek >= DayOfWeek.Monday && currentTime.DayOfWeek <= DayOfWeek.Friday)
            {
